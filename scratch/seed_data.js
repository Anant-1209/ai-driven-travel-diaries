...
const seedDB = async () => {
  try {
    ...
    console.log('Clearing old cache and connecting to MongoDB...');
    
    // Wipe old demo posts to make room for the new list
    await Post.deleteMany({ userId: '65f123456789012345678901' });

    await Post.insertMany(posts);
    console.log('SUCCESS: 24 iconic destinations added for North, South, West, and East India!');
    process.exit();
  } catch (err) {
